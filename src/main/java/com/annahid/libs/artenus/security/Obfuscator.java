...
/**
 * <p>Interface used to allow application authors to obfuscate licensing data that will be stored
 * into a SharedPreferences file.</p>
 * <p>
 ...
 * obfuscated preferences from being shared among devices.</p>
 */
...
public interface Obfuscator {
     ...
     *
     * @param obfuscated The obfuscated data.
     * @param key        The key for the data that is to be obfuscated
     *
     * @return A transformed version of the original data
     *
