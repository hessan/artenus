 ...
 * An Inventory is returned by such methods as {@link com.annahid.libs.artenus.internal.unified.GoogleIabHelper#queryInventory}.
 */
@SuppressWarnings("UnusedDeclaration")
final class Inventory {
	Map<String, IabSkuDetails> mSkuMap = new HashMap<>();
